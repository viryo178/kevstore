...
<main id="main" class="main">
  ...
  <section class="section dashboard">
    ...
    <div class="row">
      ...
      <!-- TOTAL DEACTIVED -->
      <div class="col-xxl-3 col-md-6">
        <a href="<?= base_url('user/deactived') ?>" class="stat-card-link">
          ...
          <div class="card-body">
            ...
            <div class="kelola-akun-card-head">
              ...
              <div class="kelola-akun-card-actions">
                <form id="bulkEditSelectForm" action="<?= base_url('user/bulk_edit_akun') ?>" method="GET"></form>

                <a
                  href="<?= base_url('user/bulk_tambah_akun?product=' . rawurlencode($bulk_product)) ?>"
                  ...
                  <?php foreach ($akun as $a): ?>
                    ...
                    <tr id="akun-row-<?= $a->id_akun ?>"
                      ...
                      <td class="d-flex gap-2">
                        ...
                        <a href="<?= base_url('user/detail_akun/' . $a->id_akun) ?>"
                          class="btn-detail">
...
<script>
  ...
  function fillEditAkunModal(id) {
    ...
    form.elements.kategori.value = isPasswordExpPage ? 'belum_terjual' : (account.kategori || 'private');
    form.elements.status.value = isPasswordExpPage ? 'aktif' : (normalizeStatusValue(account.status) || 'aktif');
    ...
    form.elements.max_user.value = isPasswordExpPage ? '0' : fieldValue(account.max_user);
