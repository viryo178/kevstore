    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="activity-filter" method="get" action="<?= base_url('user/aktivitas') ?>">
          ...
          <a href="<?= base_url('user/aktivitas') ?>" class="btn btn-sm activity-badge-btn activity-badge-muted">
              ...
              <tr>
                ...
                <td>
                  <div class="activity-actions">
                    <a href="<?= base_url('user/detail_activity/' . $a->id) ?>" class="btn btn-sm activity-badge-btn activity-badge-blue">
                      <i class="bi bi-eye"></i> Detail
                    </a>

                    <a href="<?= base_url('user/hapus_activity/' . $a->id) ?>" class="btn btn-sm activity-badge-btn activity-badge-red" onclick="return confirm('Apakah Anda yakin ingin menghapus log aktivitas ini?')">
