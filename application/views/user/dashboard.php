      ...
      <div class="col-lg-8">
        ...
        <div class="row">
          ...
          <?php foreach ($produk_belum_terjual as $nama_produk => $jumlah_produk): ?>
            <div class="col-xxl-4 col-md-6">
              <a href="<?= base_url('user/kelola_akun?search_akun=' . rawurlencode($nama_produk) . '&product=' . rawurlencode($nama_produk)) ?>" class="text-decoration-none">
                <div class="card info-card customers-card">
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="card-body">
                ...
                <?php if (!empty($akun_belum_penuh)): ?>
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-borderless align-middle" id="tableAkun">
...
if (searchAkun) {
  ...
  document.addEventListener('click', function(e) {
    ...
    fetch('<?= base_url('user/get_akun/') ?>' + id)
  ...
  document.getElementById('formEditAkun')
    .addEventListener('submit', function(e) {
      ...
      fetch('<?= base_url('user/edit_akun/') ?>' + id, {
          method: 'POST',
          headers: {
