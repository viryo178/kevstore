      ...
      <div class="dashboard-notif-list">
        <?php
          ...
          foreach ($problem_status_config as $problem_status => $config) {
              ...
              $dashboard_notification_groups[] = ['id'=>'status-'.$problem_status,'title'=>$config[0],'description'=>count($problem_status_groups[$problem_status]).' akun perlu dicek','icon'=>$config[1],'severity'=>'notif-warning','accounts'=>$problem_status_groups[$problem_status],'meta'=>'status'];
          }
        ?>
