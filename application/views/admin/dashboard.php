...
<!--
  Dashboard asset fallback.
  Sebagian browser/proxy pernah menyimpan dokumen /admin tanpa stylesheet dari
  template. Muat ulang aset inti dengan cache key khusus dashboard agar header,
  sidebar, ikon, Bootstrap, dan tema tetap pulih tanpa memengaruhi halaman lain.
-->
<link rel="stylesheet" href="<?= base_url('assets/vendor/bootstrap/css/bootstrap.min.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/vendor/bootstrap/css/bootstrap.min.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/vendor/bootstrap-icons/bootstrap-icons.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/vendor/bootstrap-icons/bootstrap-icons.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/vendor/boxicons/css/boxicons.min.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/vendor/boxicons/css/boxicons.min.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/vendor/remixicon/remixicon.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/vendor/remixicon/remixicon.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/vendor/simple-datatables/style.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/vendor/simple-datatables/style.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/css/custom-dark.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/css/custom-dark.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/css/keep.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/css/keep.css') ?>">
<link rel="stylesheet" href="<?= base_url('assets/css/style.css') ?>?dashboard=<?= filemtime(FCPATH . 'assets/css/style.css') ?>">
