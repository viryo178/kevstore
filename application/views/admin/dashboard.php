  ...
  <div class="admin-dashboard-grid">
    <div class="dashboard-main-grid">
      <?php foreach ($metricCards as $index => $card): ?>
        <a class="metric-link" href="<?= $card[4] ?>">
      ...
      <?php endforeach; ?>
      <div class="dashboard-empty-slot wide" aria-hidden="true"></div><div class="dashboard-empty-slot" aria-hidden="true"></div>
