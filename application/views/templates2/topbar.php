  ...
  <div class="modal fade" id="editModal" tabindex="-1">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form id="formEdit" method="POST" action="<?= base_url('user/edit_akun/') ?>">
  ...
  <script>
    document.querySelectorAll('.notif-open').forEach(btn => {
      ...
      btn.addEventListener('click', async function() {
        ...
        try {
          ...
          const res = await fetch("<?= base_url('user/get_akun/') ?>" + id);
    ...
    document.getElementById('formEdit').addEventListener('submit', async function(e) {
      ...
      try {
        ...
        const res = await fetch("<?= base_url('user/update_akun_ajax') ?>", {
          method: "POST",
          body: formData
        });
