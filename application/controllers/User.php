...
class User extends CI_Controller
{
    ...
    private function respond_akun_error($message, $redirect = 'user/kelola_akun')
    {
...
private function get_notification_data()
{
    ...
    public function tambah_akun()
    {
        ...
        $this->load->view('templates/topbar', $data);
        $this->load->view('templates/sidebar');
        $this->load->view('user/tambah_akun');
        $this->load->view('templates/footer');
    }
    ...
    public function bulk_tambah_akun()
    {
        if (!$this->input->post()) {
            ...
            $this->load->view('templates/topbar', $data);
            $this->load->view('templates/sidebar');
            $this->load->view('user/bulk_tambah_akun', $data);
            $this->load->view('templates/footer');
            return;
        }
    ...
    public function bulk_edit_akun()
    {
        if (!$this->input->post()) {
            ...
            $this->load->view('templates/topbar', $data);
            $this->load->view('templates/sidebar');
            $this->load->view('user/bulk_edit_akun', $data);
            $this->load->view('templates/footer');
            return;
        }
    ...
    public function hapus_activity($id)
    {
        ...
        redirect('user/aktivitas');
    }
    // ======================================================
    // HALAMAN KEPEGAWAIAN
    // URL : user/kepegawaian
    // ======================================================
    ...
    public function kepegawaian()
    {
        ...
        $this->load->view('templates/topbar', $data);
        $this->load->view('templates/sidebar');
        $this->load->view('user/kepegawaian', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function simpan_absensi()
    {
        ...
        if (is_array($status)) {
            ...
            redirect('user/kepegawaian?bulan=' . $bulan);
        }
        ...
        redirect('user/kepegawaian?bulan=' . date('Y-m', strtotime($tanggal)));
    }
    ...
    // ======================================================
    // EXPORT EXCEL
    // URL : user/export_kepegawaian?bulan=2026-05
    // ======================================================
