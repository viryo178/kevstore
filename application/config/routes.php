...
$route['admin/akun_penjualan'] = 'admin/akun_penjualan';
$route['admin/bin'] = 'admin/bin';
$route['admin/bin/pulihkan/(:num)'] = 'admin/pulihkan_akun_bin/$1';
$route['admin/deactived'] = 'admin/deactived';
$route['admin/akun_bermasalah'] = 'admin/deactived';
...
$route['admin/jenis_akun/hapus/(:num)'] = 'admin/hapus_jenis_akun/$1';
...
$route['admin/bulk_hapus_akun'] = 'admin/bulk_hapus_akun';
$route['user/kelola_akun'] = 'user/kelola_akun';
$route['user/deactived'] = 'user/deactived';
$route['user/ganti_password_exp'] = 'user/ganti_password_exp';
...
$route['user/bulk_hapus_akun'] = 'user/bulk_hapus_akun';
...
$route['api/akun/bulk']['post'] = 'api/bulk_akun';
$route['api/akun/bulk']['put'] = 'api/bulk_akun';
$route['api/akun/bulk']['patch'] = 'api/bulk_akun';
$route['api/akun/deactived']['get'] = 'api/akun_deactived';
$route['api/akun/ganti-password-exp']['get'] = 'api/akun_ganti_password_exp';
...
$route['api/chat/conversations']['get'] = 'api/chat_conversations';
$route['api/chat/send']['post'] = 'api/chat_send';
$route['api/chat/delete']['post'] = 'api/chat_delete';
$route['api/chat/prompts']['get'] = 'api/chat_prompts';
$route['api/chat/projects']['get'] = 'api/chat_projects';
