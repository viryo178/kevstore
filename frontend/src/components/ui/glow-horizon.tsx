...
export default function GlowHorizonFM({ className, variant = "top" }: GlowHorizonProps) {
  ...
  return (
    <motion.div
      className={"absolute left-1/2 top-0 h-[28rem] w-[150vw] -ml-[75vw] sm:left-0 sm:h-full sm:w-full sm:ml-0 " + (className ?? "")}
    ...
    >
      <Arc variant={variant} color="rgba(255,255,255,0.9)" size="132%" boxShadow="0px -4px 23px 0px #ffffffb5" delay={1.2} />
      <Arc variant={variant} color="var(--theme-400)" size="120%" initialOffset="10%" blur={31} delay={0.6} />
      <Arc variant={variant} color="var(--theme-700)" size="124%" initialOffset="10%" blur={21} delay={0} />
